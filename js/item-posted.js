...
function show() {
    ...
    if (
        ...
        document.querySelector('#type').checkValidity() &&
        document.querySelector('#description').checkValidity() &&
        document.querySelector('#price').checkValidity() &&
        document.querySelector('#image').checkValidity()
    ) {
        alert(
